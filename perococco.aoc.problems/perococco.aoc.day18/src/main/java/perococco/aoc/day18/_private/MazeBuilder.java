...
public class MazeBuilder {
    ...
    @NonNull
    public static Maze create(@NonNull ImmutableList<String> lines) {
        return new MazeBuilder(lines,false).build();
    }

    @NonNull
    public static Maze splitAndCreate(@NonNull ImmutableList<String> lines) {
    ...
    public Maze build() {
        ...
        return new Maze(walls, width, height, ImmutableMap.copyOf(doors),ImmutableMap.copyOf(keys));
    }
