...
public class Day20Part2Problem extends Day20Problem {

    public Day20Part2Problem() {
        super(Part.PART_2);
    }

    public Day20Part2Problem(@NonNull ImmutableList<String> lines) {
        super(Part.PART_2, lines);
    }

    @Override
    Function<? super ArrayOfChar,? extends Maze> mazeBuilder() {
        return Maze::createRecursive;
    }
}
